...
export 'src/emotes.dart'
    show
        ...
        parseMessage,
        parseMessagePayload,
        parseMessagePayloadWithExternalEmotes,
        parseMessageWithExternalEmotes;
export 'src/enrichment.dart'
    show
        KickEnrichmentHttpException,
...
export 'src/events.dart'
    show
        ...
        KickGoalAction,
        KickGoalEvent,
        KickKicksGiftedEvent,
        KickKnownEvent,
        KickLivestreamAction,
        KickLivestreamEvent,
        KickMessageDeletedEvent,
        KickPollDeletedEvent,
        KickPollOption,
        KickPollUpdatedEvent,
        KickPinnedMessageCreatedEvent,
        KickPinnedMessageDeletedEvent,
        KickProtocolException,
        KickReward,
        KickRewardRedeemedEvent,
        KickStreamHostedEvent,
